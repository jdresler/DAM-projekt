...
kings1 <- read.csv2("/Users/user/Desktop/Historie AU/2. Semester/Digitale_arkiver_metoder/kongerækken-csv-2.csv")
head(kings1)
glimpse(kings1)
class(kings1)


kings2 <- read_csv2("/Users/user/Desktop/Historie AU/2. Semester/Digitale_arkiver_metoder/kongerækken-csv-2.csv")
glimpse(kings2)
class(kings2)

kings3 <- read.csv2("/Users/user/Desktop/Historie AU/2. Semester/Digitale_arkiver_metoder/kongerækken-csv-2.csv")
glimpse(kings3)
head(kings3)
class(kings3)

kings4 <- read_csv2( "/Users/user/Desktop/Historie AU/2. Semester/Digitale_arkiver_metoder/kongerækken-csv-2.csv")
glimpse(kings4)
head(kings4)
class(kings4)
```
...
kings <- read.csv2("/Users/user/Desktop/Historie AU/2. Semester/Digitale_arkiver_metoder/kongerækken-csv-2.csv")
